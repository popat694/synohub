...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | SynoHub - React.js Admin Dashboard Template"
        description="This is React.js Videos page for SynoHub - React.js Tailwind CSS Admin Dashboard Template"
      />
