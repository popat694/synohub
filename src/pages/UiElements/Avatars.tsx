...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | SynoHub - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for SynoHub - React.js Tailwind CSS Admin Dashboard Template"
      />
